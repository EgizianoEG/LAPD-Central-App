 ...
 * additional cleanup by replacing multiple spaces in specific contexts with a single space:
 * - Periods followed by two or more spaces with a single space after the period.
 * - Any non-whitespace characters separated by two or more spaces with a single space.
 *
